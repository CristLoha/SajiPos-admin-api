    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Campaign</h2>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                                name="start_date" value="{{ old('start_date', $campaign->start_date) }}" required>
                                            @error('start_date')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                                name="end_date" value="{{ old('end_date', $campaign->end_date) }}" required>
                                            @error('end_date')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select class="form-control selectric @error('discount_type') is-invalid @enderror"
                                                ...
                                                <option value="percent" {{ old('discount_type', $campaign->discount_type) == 'percent' ? 'selected' : '' }}>Persentase (%)</option>
                                                <option value="nominal" {{ old('discount_type', $campaign->discount_type) == 'nominal' ? 'selected' : '' }}>Potongan Tetap (Nominal)</option>
                                            </select>
                                            @error('discount_type')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="input-group">
                                                <input type="number" class="form-control @error('discount_value') is-invalid @enderror"
                                                    name="discount_value" value="{{ old('discount_value', intval($campaign->discount_value)) }}" min="0" required>
                                                    ...
                                                    <label class="list-group-item list-group-item-action d-flex align-items-center mb-0" style="cursor: pointer;">
                                                        <div class="custom-control custom-checkbox mr-3">
                                                            <input type="checkbox" name="products[]" value="{{ $product->id }}" class="custom-control-input" id="prod_{{ $product->id }}" 
                                                                {{ in_array($product->id, old('products', $campaign->products->pluck('id')->toArray())) ? 'checked' : '' }}>
