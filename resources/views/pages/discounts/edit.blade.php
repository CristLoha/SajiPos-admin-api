    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Diskon: {{ $discount->name }}</h2>
                <p class="section-lead">Perbarui promo diskon di bawah ini.</p>
                        ...
                        <div class="card">
                            <form action="{{ route('discounts.update', $discount->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea 
                                                ...
                                                style="height: auto;">{{ old('description', $discount->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select 
                                                ...
                                                <option value="fixed" {{ old('type', $discount->type) == 'fixed' ? 'selected' : '' }}>Potongan Tetap (Rupiah)</option>
                                            </select>
                                            @error('type')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('max_discount') is-invalid @enderror" name="max_discount" id="max_discount" value="{{ old('max_discount', $discount->max_discount) }}" placeholder="Contoh: 20000" min="0">
                                                    @error('max_discount')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control @error('min_transaction') is-invalid @enderror" name="min_transaction" id="min_transaction" value="{{ old('min_transaction', $discount->min_transaction) }}" placeholder="Contoh: 50000" min="0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select 
                                                ...
                                                id="status" 
                                                required>
                                                <option value="active" {{ old('status', $discount->status) == 'active' ? 'selected' : '' }}>Aktif</option>
                                                <option value="inactive" {{ old('status', $discount->status) == 'inactive' ? 'selected' : '' }}>Non-aktif</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" 
                                                ...
                                                name="expired_date" 
                                                id="expired_date" 
                                                value="{{ old('expired_date', $discount->expired_date) }}">
                                            @error('expired_date')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('quota') is-invalid @enderror" name="quota" id="quota" value="{{ old('quota', $discount->quota) }}" placeholder="Contoh: 100" min="0">
                                            @error('quota')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <button class="btn btn-primary" type="submit">Perbarui Diskon</button>
                                </div>
                            </form>
                        </div>
                    </div>
